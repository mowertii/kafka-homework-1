...
echo   docker exec -it kafka-training-broker /opt/kafka/bin/kafka-console-consumer.sh --bootstrap-server localhost:19092 --topic orders.dlt --from-beginning --property print.key=true --property print.headers=true --max-messages 10
echo
